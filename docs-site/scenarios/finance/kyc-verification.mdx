  ...
  'kyc-verification': [
    {
      ...
      linkTypes: [
        { name: 'identityDocuments', targetObjectType: 'identity-document', cardinality: 'one-to-many' as const },
        { name: 'riskAssessments', targetObjectType: 'risk-assessment', cardinality: 'one-to-many' as const },
      ],
      actions: [],
