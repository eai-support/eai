  ...
  'supply-chain': [
    {
      ...
      linkTypes: [
        { name: 'purchaseOrders', targetObjectType: 'purchase-order', cardinality: 'one-to-many' as const },
      ],
      actions: [],
    ...
    },
    {
      ...
      linkTypes: [
        { name: 'purchaseOrder', targetObjectType: 'purchase-order', cardinality: 'many-to-one' as const },
      ],
      actions: [
        {
          name: 'acceptDelivery',
