  ...
  'defect-management': [
    {
      ...
      linkTypes: [
        { name: 'rootCauseAnalyses', targetObjectType: 'root-cause-analysis', cardinality: 'one-to-many' as const },
    ...
    },
    {
      ...
      linkTypes: [
        { name: 'defectReport', targetObjectType: 'defect-report', cardinality: 'many-to-one' as const },
      ],
      actions: [],
      status: 'published' as const,
    },
