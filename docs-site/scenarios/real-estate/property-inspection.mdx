  ...
  'property-inspection': [
    {
      ...
      linkTypes: [
        { name: 'checklistItems', targetObjectType: 'checklist-item', cardinality: 'one-to-many' as const, cascadeDelete: true },
