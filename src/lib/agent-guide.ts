  ...
  commonWorkflows: [
    ...
    },
    {
      ...
      commands: [
        ...
        { command: 'eai resources file upload <type> <id> <property> <path> --tenant-id <tenant-id>', mutates: true, purpose: 'Attach a file to an existing ResourceAPI object file property.' },
      ],
    },
    {
      step: 6,
