...
//
// runCommand('eai chat send "Follow up" --workflow workflow-123 --conversation-id conv-456')
//
...
// publishedDocumentWorkflow('business-docs', 'invoice-review')
// publicAPIReturnsQueuedJob({ jobId: 'job-123', documentId: 'doc-123' })
//
...
| `publicAPIReachable()` | Mock `/v4/data/resources/object-types` | P0 |
