...
If the attachment is required for a vulnerability report, please use private vulnerability reporting instead: https://github.com/eai-tools/eai/security/advisories/new`;
}
